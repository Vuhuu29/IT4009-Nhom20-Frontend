export default function RoomView(props) {
    ...
    <div className={"m-5 p-2 " + props.room.status} style={{background: '#fdeeee', boxShadow: 'rgba(0, 0, 0, 0.34) 0px 5px 20px -17px', position: 'relative', width: '90%'}}>
        ...
        <div className="col mt-2 px-2" style={{fontSize: 14}}>
            <div className="row mb-1" style={{border: '1px solid #1B9C85', padding: 5}}>
                <div className="col d-flex align-items-center" style={{borderRight: '1px solid #1B9C85'}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-bounding-box me-1" viewBox="0 0 16 16">
            ...
            <div className="row mb-1" style={{border: '1px solid #1B9C85', padding: 5}}>
                ...
                <div className="col d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-x me-1" viewBox="0 0 16 16">

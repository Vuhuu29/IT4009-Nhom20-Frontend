...
export default function RoomView(props) {
    return (
    <div className="m-5 p-2 border-top rounded-1 border-warning border-3" style={{background: '#fdeeee', borderColor: '#7A3E3E', boxShadow: '5px 10px #888888', zIndex: 2, position: 'relative'}}>
        <div className="d-flex flex-row" style={{fontSize: 20}}>
            ...
            {props.room.num + '/' + props.room.max_num}
            </div>
        </div>

export default function RoomView(props) {
    return (
    <div className={"m-5 p-2 " + props.room.status} style={{fontSize: 14, background: '#FFF5EE', boxShadow: 'rgba(0, 0, 0, 0.34) 0px 5px 20px -17px', position: 'relative', width: '90%'}}>
        ...
        <div className="col mt-2 px-2" >
            ...
            <div className="row mb-1" style={{border: '1px solid #000', padding: 5}}>
                ...
                <div className="col d-flex align-items-center">
                    ...
                    {(props.room.duration) ? (props.room.duration + " Tháng") : "--"}
                </div>
            </div>
            ...
            <div className="row mb-1" style={{border: '1px solid #000', padding: 5}}>
                <div className="col d-flex align-items-center" style={{borderRight: '1px solid #000'}}>
                    ...
                    {(props.room.start_time) ? props.room.start_time : "--"}
                </div>

                <div className="col d-flex align-items-center">
                    <img src="./file-earmark-x.svg" className="me-1"/>
                    {(props.room.end_time) ? props.room.end_time : "--"}
                </div>
            </div>
            ...
            <div className="row mb-1" style={{border: '1px solid #000', padding: 5}}>
                <div className="col d-flex align-items-center" style={{borderRight: '1px solid #000'}}>
                    ...
                    {(props.room.state1) ? props.room.state1 : "--"}
                </div>
                <div className="col d-flex align-items-center">
                    
                    <img src="./journal-check.svg" className="me-1"/>    
                    {(props.room.state2) ? props.room.state2 : "--"}
                </div>
            </div>

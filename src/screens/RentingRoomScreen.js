  ...
  return (
    <>
      ...
      <div className="d-flex flex-row align-items-center mb-2">
        ...
        <Modal centered className="modal-lg my-auto" show={show} onHide={() => setShow(false)}>
      ...
      <table class="table table-bordered rounded-1">
        <thead>
          <tr>
            ...
            <th scope="col" className="mb-2">Tên phòng</th>
            <th scope="col"  className="mb-2">Số người ở tối đa</th>
            <th scope="col"  className="mb-2">Đơn giá</th>
            <th scope="col"  className="mb-2">Trạng thái</th>
            <th scope="col"  className="mb-2">Mô tả</th>
          </tr>
        </thead>
        <tbody>
          {room.map((data, index) => (
